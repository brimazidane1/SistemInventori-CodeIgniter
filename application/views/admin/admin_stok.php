                    ...
                    <?php foreach ($stok as $s) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/hapus_stok/' . $s['id_barang'] . '/' .  $s['id_stok']); ?>" class="btn btn-primary">Hapus</a>
                                <a href="<?php echo site_url("admin/print_stok/" . $s['id_stok'] . '/' . $s['merk_barang'] . '/' . $s['nama_barang'] . '/' . $s['tanggal_stok']) ?>" class="btn btn-danger">Print</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
    ...
    <div class="modal fade" id="editStokModal<?= $s['id_stok']; ?>" tabindex="-1" role="dialog" aria-labelledby="editStokModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/edit_stok'); ?>" method="post">
...
<div class="modal fade" id="tambahStokModal" tabindex="-1" role="dialog" aria-labelledby="tambahStokModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kartu_stok/' . $id_barang); ?>" method="post">
                <div class="modal-body">
