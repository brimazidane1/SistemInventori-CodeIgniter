                        ...
                        <tbody>
                            ...
                            <?php foreach ($boking as $b) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('admin/approved_boking/' . $b['id_boking']); ?>" class="btn btn-primary">Approved</a>
                                        <a href="<?= base_url('admin/batal_approved_boking/' . $b['id_boking']); ?>" class="btn btn-primary">Batal</a>
                                        <a href="<?= base_url('admin/hapus_boking/' . $b['id_boking']); ?>" class="btn btn-primary">Hapus</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        <tfoot>
        ...
        <div class="modal fade" id="tambahBokingModal" tabindex="-1" role="dialog" aria-labelledby="tambahBokingModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('admin/boking'); ?>" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="nama_boking" name="nama_boking" placeholder="Nama Boking">
                            </div>
